...
public class ShowDamagePlugin : BasePlugin
{
    ...
    public class Config
    {
        public string GrenadeDamageMessage { get; set; } = "手榴弹总伤害: <font color='red'>{0}❤</font>";
        public string DamageMessage { get; set; } = "伤害: <font color='red'>{0}♥</font>, 剩余生命值: <font color='green'>{1}❤</font>, 命中部位: <font color='yellow'>{2}</font>";
        public string ShowDamageEnabledMessage { get; set; } = "[ {Green}显示伤害{White} ] 伤害显示 {Green}已开启{White}.";
        public string ShowDamageDisabledMessage { get; set; } = "[ {Red}显示伤害{White} ] 伤害显示 {Red}已关闭{White}.";
    }
}
