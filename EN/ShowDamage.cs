...
public class ShowDamagePlugin : BasePlugin
{
    ...
    [ConsoleCommand("damage", "Toggle damage display")]
    ...
    public class Config
    {
        public string GrenadeDamageMessage { get; set; } = "Total grenade damage: <font color='red'>{0}❤</font>";
        public string DamageMessage { get; set; } = "Damage: <font color='red'>{0}♥</font>, Remaining HP: <font color='green'>{1}❤</font>, Hit: <font color='yellow'>{2}</font>";
        public string ShowDamageEnabledMessage { get; set; } = "[ {Green}ShowDamage{White} ] Damage display {Green}enabled{White}.";
        public string ShowDamageDisabledMessage { get; set; } = "[ {Red}ShowDamage{White} ] Damage display {Red}disabled{White}.";
    }
}
